...
import { formatDate, formatTime } from '@/app/features/lib/utils';
        ...
        <View className="flex flex-row items-center justify-between">
            ...
            <View className="flex felx-col mx-5 gap-y-5 flex-1">
                <View className="flex flex-row items-center gap-x-2">
                    <Image source={require('@/assets/icons/to.png')} className="w-5 h-5"/>
                ...
                <View className="flex flex-row items-center gap-x-2">
                    <Image source={require('@/assets/icons/point.png')} className="w-5 h-5"/>
                    <Text className="text-md font-JakartaMedium"
                    numberOfLines={1}
